    ...
    <nav className="sticky top-0 z-50 bg-white/95 backdrop-blur-md shadow-[0_1px_3px_rgba(0,0,0,0.08)]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 md:h-18">
          ...
          <a
            href="#contact"
            className="hidden md:inline-flex items-center px-5 py-2.5 bg-primary text-white
                       text-sm font-semibold rounded-lg shadow-sm
          ...
          <button
            ...
            className="md:hidden relative w-10 h-10 flex items-center justify-center
                       rounded-lg text-gray-600 hover:text-primary hover:bg-gray-50
